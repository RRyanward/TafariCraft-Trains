/* Step 8.4.2 Batch B3: USATC S100 UK Steam Locomotive. Debug intentionally enabled. */
...
public class S100UkSteamLocomotive extends SmallSteamLocomotive {
    /*
     ...
     */
    private static final double VISUAL_DRIVER_SEAT_BACK_OFFSET = 0.3797D;
    ...
    private static final double VISUAL_CHIMNEY_FRONT_OFFSET = 1.2344D;
    private static final double VISUAL_CHIMNEY_TOP_Y_OFFSET = 1.7188D;
     ...
     * Southern Railway USA/S100 UK representative: ~47.2 t working weight, ~96.2 kN TE, 40 mph (64.4 km/h) service max.
    ...
    public S100UkSteamLocomotive(EntityType<? extends S100UkSteamLocomotive> type, Level level) {
        super(type, level);
    }
    ...
    public void tick() {
        super.tick();
        LegacyRollingStockDebug.logEntity(this, "USATC S100 UK Steam Locomotive");
    }

    @Override
    protected Item getDropItem() {
        return TCItems.LOCOMOTIVE_STEAM_S100_UK.get();
    }

    @Override
    public ItemStack getPickResult() {
        return new ItemStack(TCItems.LOCOMOTIVE_STEAM_S100_UK.get());
    }
}
