/* Step 8.4.5 Batch B6: Coronation Class Steam Locomotive. Debug intentionally enabled. */
...
public class CoronationClassSteamLocomotive extends SmallSteamLocomotive {
    /*
     * STEP_8_5_8A_R1_REALISM
     * Step 8.5.8a-r1 Batch A per-locomotive realism calibration.
     * LMS Coronation representative: 106.9 t conventional locomotive, 177.9 kN starting TE, 114 mph recorded basis.
     ...
     */
    private static final double REALISM_MASS_T = 106.9D;
    private static final double REALISM_TRACTION_REFERENCE_MASS_T = 355.9D;
    private static final double REALISM_BASE_ACCELERATION_MPS2 = 0.500D;
    private static final double REALISM_MAX_FORWARD_BPT = 183.5D / 72.0D;
     ...
     */
    private static final double VISUAL_DRIVER_SEAT_BACK_OFFSET = -0.0856D;
    ...
    private static final double VISUAL_CHIMNEY_FRONT_OFFSET = 5.4406D;
    private static final double VISUAL_CHIMNEY_TOP_Y_OFFSET = 2.3438D;
    ...
    public CoronationClassSteamLocomotive(EntityType<? extends CoronationClassSteamLocomotive> type, Level level) {
        super(type, level);
    }
    ...
    public void tick() {
        super.tick();
        LegacyRollingStockDebug.logEntity(this, "Coronation Class Steam Locomotive");
    }

    @Override
    protected Item getDropItem() {
        return TCItems.LOCOMOTIVE_STEAM_CORONATION_CLASS.get();
    }

    @Override
    public ItemStack getPickResult() {
        return new ItemStack(TCItems.LOCOMOTIVE_STEAM_CORONATION_CLASS.get());
    }
}
