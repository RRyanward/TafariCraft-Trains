/* Step 8.4.5 Batch B6: GWR 72xx Steam Locomotive. Debug intentionally enabled. */
...
public class Gwr72xxSteamLocomotive extends SmallSteamLocomotive {
    /*
     ...
     */
    private static final double VISUAL_DRIVER_SEAT_BACK_OFFSET = -0.0610D;
    ...
    private static final double VISUAL_CHIMNEY_FRONT_OFFSET = 4.1384D;
     ...
     * GWR 72xx 2-8-2T representative (7202-type): ~94.1 t, ~147.5 kN starting effort. 64.4 km/h is a conservative heavy-freight gameplay/service cap.
    ...
    public Gwr72xxSteamLocomotive(EntityType<? extends Gwr72xxSteamLocomotive> type, Level level) {
        super(type, level);
    }
    ...
    public void tick() {
        super.tick();
        LegacyRollingStockDebug.logEntity(this, "GWR 72xx Steam Locomotive");
    }

    @Override
    protected Item getDropItem() {
        return TCItems.LOCOMOTIVE_STEAM_GWR_72XX.get();
    }

    @Override
    public ItemStack getPickResult() {
        return new ItemStack(TCItems.LOCOMOTIVE_STEAM_GWR_72XX.get());
    }
}
