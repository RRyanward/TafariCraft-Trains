/* Step 8.4.6 Batch B7: J50 Steam Locomotive. Debug intentionally enabled. */
...
public class J50SteamLocomotive extends SmallSteamLocomotive {
    /*
     ...
     */
    private static final double VISUAL_DRIVER_SEAT_BACK_OFFSET = 0.4471D;
    ...
    private static final double VISUAL_CHIMNEY_FRONT_OFFSET = 2.6562D;
     ...
     * LNER J50 later-series representative: ~59.1 t, ~105.1 kN starting effort. 80.5 km/h (50 mph) is a shunting/short-trip gameplay service cap.
    ...
    public J50SteamLocomotive(EntityType<? extends J50SteamLocomotive> type, Level level) {
        super(type, level);
    }
    ...
    public void tick() {
        super.tick();
        LegacyRollingStockDebug.logEntity(this, "J50 Steam Locomotive");
    }

    @Override
    protected Item getDropItem() {
        return TCItems.LOCOMOTIVE_STEAM_J50.get();
    }

    @Override
    public ItemStack getPickResult() {
        return new ItemStack(TCItems.LOCOMOTIVE_STEAM_J50.get());
    }
}
