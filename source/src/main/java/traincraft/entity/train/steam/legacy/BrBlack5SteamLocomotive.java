/* Step 8.4.4 Batch B5: BR Black 5 Steam Locomotive. Debug intentionally enabled. */
...
public class BrBlack5SteamLocomotive extends SmallSteamLocomotive {
    /*
     * STEP_8_5_8A_R1_REALISM
     * Step 8.5.8a-r1 Batch A per-locomotive realism calibration.
     * LMS Stanier Black Five representative: 73.4 t locomotive, 113.2 kN starting TE; 90 mph service/gameplay cap.
     ...
     */
    private static final double REALISM_MASS_T = 73.4D;
    private static final double REALISM_TRACTION_REFERENCE_MASS_T = 251.6D;
     ...
     */
    private static final double VISUAL_DRIVER_SEAT_BACK_OFFSET = 0.0348D;
    ...
    private static final double VISUAL_CHIMNEY_FRONT_OFFSET = 3.0625D;
    private static final double VISUAL_CHIMNEY_TOP_Y_OFFSET = 1.7313D;
    ...
    public BrBlack5SteamLocomotive(EntityType<? extends BrBlack5SteamLocomotive> type, Level level) {
        super(type, level);
    }
    ...
    public void tick() {
        super.tick();
        LegacyRollingStockDebug.logEntity(this, "BR Black 5 Steam Locomotive");
    }

    @Override
    protected Item getDropItem() {
        return TCItems.LOCOMOTIVE_STEAM_BR_BLACK_5.get();
    }

    @Override
    public ItemStack getPickResult() {
        return new ItemStack(TCItems.LOCOMOTIVE_STEAM_BR_BLACK_5.get());
    }
}
