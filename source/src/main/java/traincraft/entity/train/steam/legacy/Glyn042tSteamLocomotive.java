/* Step 8.4.7 Batch B8: GLYN 0-4-2T Steam Locomotive. Debug intentionally enabled. */
...
public class Glyn042tSteamLocomotive extends SmallSteamLocomotive {
    /*
     ...
     */
    private static final double VISUAL_DRIVER_SEAT_BACK_OFFSET = 0.1712D;
    private static final double VISUAL_DRIVER_SEAT_Y_OFFSET = 0.4806D;
    private static final double VISUAL_DRIVER_SEAT_SIDE_OFFSET = 0.0000D;

    private static final double VISUAL_CHIMNEY_FRONT_OFFSET = 2.1375D;
    private static final double VISUAL_CHIMNEY_TOP_Y_OFFSET = 2.3756D;
     ...
     * Glyn Valley Tramway No.3 GLYN representative: ~14.7 t, ~33.35 kN starting effort; tramway operation was governed to about 10 mph / 16 km/h.
    ...
    public Glyn042tSteamLocomotive(EntityType<? extends Glyn042tSteamLocomotive> type, Level level) {
        super(type, level);
    }
    ...
    public void tick() {
        super.tick();
        LegacyRollingStockDebug.logEntity(this, "GLYN 0-4-2T Steam Locomotive");
    }

    @Override
    protected Item getDropItem() {
        return TCItems.LOCOMOTIVE_STEAM_GLYN_042T.get();
    }

    @Override
    public ItemStack getPickResult() {
        return new ItemStack(TCItems.LOCOMOTIVE_STEAM_GLYN_042T.get());
    }
}
