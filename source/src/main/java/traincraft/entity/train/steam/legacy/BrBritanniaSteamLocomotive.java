/* Step 8.4.4 Batch B5: BR Britannia Steam Locomotive. Debug intentionally enabled. */
...
public class BrBritanniaSteamLocomotive extends SmallSteamLocomotive {
    /*
     * STEP_8_5_8A_R1_REALISM
     * Step 8.5.8a-r1 Batch A per-locomotive realism calibration.
     * BR Standard Class 7 Britannia: 95.5 t locomotive, 143.0 kN starting TE, 90 mph class speed.
     ...
     */
    private static final double REALISM_MASS_T = 95.5D;
    private static final double REALISM_TRACTION_REFERENCE_MASS_T = 286.0D;
     ...
     */
    private static final double VISUAL_DRIVER_SEAT_BACK_OFFSET = 0.0668D;
    ...
    private static final double VISUAL_CHIMNEY_FRONT_OFFSET = 3.7062D;
    private static final double VISUAL_CHIMNEY_TOP_Y_OFFSET = 1.8125D;
    ...
    public BrBritanniaSteamLocomotive(EntityType<? extends BrBritanniaSteamLocomotive> type, Level level) {
        super(type, level);
    }
    ...
    public void tick() {
        super.tick();
        LegacyRollingStockDebug.logEntity(this, "BR Britannia Steam Locomotive");
    }

    @Override
    protected Item getDropItem() {
        return TCItems.LOCOMOTIVE_STEAM_BR_BRITANNIA.get();
    }

    @Override
    public ItemStack getPickResult() {
        return new ItemStack(TCItems.LOCOMOTIVE_STEAM_BR_BRITANNIA.get());
    }
}
