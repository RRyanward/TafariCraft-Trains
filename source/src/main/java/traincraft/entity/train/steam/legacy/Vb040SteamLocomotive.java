/* Step 8.4.6 Batch B7: VB 0-4-0 Steam Locomotive. Debug intentionally enabled. */
...
public class Vb040SteamLocomotive extends SmallSteamLocomotive {

    /*
     * STEP_8_5_12A_R1_REALISM
     * Step 8.5.12a-r1 Batch E per-locomotive realism.
     * Representative compact 0-4-0 industrial/tank calibration; exact VB prototype identification is unresolved.
     ...
     */
    private static final double REALISM_MASS_T = 32.0D;
    private static final double REALISM_TRACTION_REFERENCE_MASS_T = 140.0D;
    private static final double REALISM_BASE_ACCELERATION_MPS2 = 0.350D;
    private static final double REALISM_MAX_FORWARD_BPT = 48.3D / 72.0D;
    private static final double REALISM_MAX_REVERSE_BPT = 48.3D / 72.0D;
     ...
     */
    private static final double VISUAL_DRIVER_SEAT_BACK_OFFSET = 0.1915D;
    ...
    private static final double VISUAL_CHIMNEY_FRONT_OFFSET = 0.6188D;
    private static final double VISUAL_CHIMNEY_TOP_Y_OFFSET = 2.3753D;
    ...
    public Vb040SteamLocomotive(EntityType<? extends Vb040SteamLocomotive> type, Level level) {
        super(type, level);
    }
    ...
    public void tick() {
        super.tick();
        LegacyRollingStockDebug.logEntity(this, "VB 0-4-0 Steam Locomotive");
    }

    @Override
    protected Item getDropItem() {
        return TCItems.LOCOMOTIVE_STEAM_VB_0_4_0.get();
    }

    @Override
    public ItemStack getPickResult() {
        return new ItemStack(TCItems.LOCOMOTIVE_STEAM_VB_0_4_0.get());
    }
}
