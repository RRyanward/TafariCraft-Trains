/* Step 8.4.7 Batch B8: C41 0-8-0 Steam Locomotive. Debug intentionally enabled. */
...
public class C41080SteamLocomotive extends SmallSteamLocomotive {
    /*
     ...
     */
    private static final double VISUAL_DRIVER_SEAT_BACK_OFFSET = 0.4162D;
     ...
     * D&RGW C-41 family basis: ~82.6 t and ~181.9 kN starting effort. Traincraft 0-8-0 variant uses symmetric 48.3 km/h switching/service caps.
    ...
    public C41080SteamLocomotive(EntityType<? extends C41080SteamLocomotive> type, Level level) {
        super(type, level);
    }
    ...
    public void tick() {
        super.tick();
        LegacyRollingStockDebug.logEntity(this, "C41 0-8-0 Steam Locomotive");
    }

    @Override
    protected Item getDropItem() {
        return TCItems.LOCOMOTIVE_STEAM_C41_080.get();
    }

    @Override
    public ItemStack getPickResult() {
        return new ItemStack(TCItems.LOCOMOTIVE_STEAM_C41_080.get());
    }
}
