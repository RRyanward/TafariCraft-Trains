/* Step 8.4.6 Batch B7: Alice 0-4-0 Steam Locomotive. Debug intentionally enabled. */
...
public class Alice040SteamLocomotive extends SmallSteamLocomotive {
    /*
     ...
     */
    private static final double VISUAL_DRIVER_SEAT_BACK_OFFSET = 0.1386D;
    ...
    private static final double VISUAL_CHIMNEY_FRONT_OFFSET = 2.1938D;
     ...
     * Alice/Dinorwic Hunslet 780: ~6.1 t working order, ~11.5 kN TE; 20 km/h cap is quarry-service gameplay calibration.
    ...
    public Alice040SteamLocomotive(EntityType<? extends Alice040SteamLocomotive> type, Level level) {
        super(type, level);
    }
    ...
    public void tick() {
        super.tick();
        LegacyRollingStockDebug.logEntity(this, "Alice 0-4-0 Steam Locomotive");
    }

    @Override
    protected Item getDropItem() {
        return TCItems.LOCOMOTIVE_STEAM_ALICE_0_4_0.get();
    }

    @Override
    public ItemStack getPickResult() {
        return new ItemStack(TCItems.LOCOMOTIVE_STEAM_ALICE_0_4_0.get());
    }
}
