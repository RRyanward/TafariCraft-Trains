/* Step 8.4.2 Batch B3: C62 Steam Locomotive. Debug intentionally enabled. */
...
public class C62SteamLocomotive extends SmallSteamLocomotive {
    /*
     * STEP_8_5_8A_R1_REALISM
     * Step 8.5.8a-r1 Batch A per-locomotive realism calibration.
     * JNR C62: 88.83 t locomotive, about 136.0 kN starting TE, 130 km/h maximum speed.
     ...
     */
    private static final double REALISM_MASS_T = 88.83D;
    private static final double REALISM_TRACTION_REFERENCE_MASS_T = 302.3D;
    private static final double REALISM_BASE_ACCELERATION_MPS2 = 0.450D;
    private static final double REALISM_MAX_FORWARD_BPT = 130.0D / 72.0D;
     ...
     */
    private static final double VISUAL_DRIVER_SEAT_BACK_OFFSET = -0.2925D;
    private static final double VISUAL_DRIVER_SEAT_Y_OFFSET = 0.3800D;
    private static final double VISUAL_DRIVER_SEAT_SIDE_OFFSET = 0.0000D;

    private static final double VISUAL_CHIMNEY_FRONT_OFFSET = 5.0312D;
    private static final double VISUAL_CHIMNEY_TOP_Y_OFFSET = 2.1500D;
    ...
    public C62SteamLocomotive(EntityType<? extends C62SteamLocomotive> type, Level level) {
        super(type, level);
    }
    ...
    public void tick() {
        super.tick();
        LegacyRollingStockDebug.logEntity(this, "C62 Steam Locomotive");
    }

    @Override
    protected Item getDropItem() {
        return TCItems.LOCOMOTIVE_STEAM_C62.get();
    }

    @Override
    public ItemStack getPickResult() {
        return new ItemStack(TCItems.LOCOMOTIVE_STEAM_C62.get());
    }
}
