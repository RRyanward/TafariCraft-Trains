/* Step 8.4.6 Batch B7: Sentinel Y3 Steam Locomotive. Debug intentionally enabled. */
...
public class SentinelY3SteamLocomotive extends SmallSteamLocomotive {

    /*
     * STEP_8_5_12A_R1_REALISM
     * Step 8.5.12a-r1 Batch E per-locomotive realism.
     * LNER Sentinel Y3 representative: about 20.8 long tons, 12,600 lbf low-gear tractive effort, 21 mph maximum.
     ...
     */
    private static final double REALISM_MASS_T = 21.1D;
    private static final double REALISM_TRACTION_REFERENCE_MASS_T = 186.8D;
    private static final double REALISM_BASE_ACCELERATION_MPS2 = 0.300D;
    private static final double REALISM_MAX_FORWARD_BPT = 33.8D / 72.0D;
    private static final double REALISM_MAX_REVERSE_BPT = 33.8D / 72.0D;
     ...
     */
    private static final double VISUAL_DRIVER_SEAT_BACK_OFFSET = 0.6027D;
    ...
    private static final double VISUAL_CHIMNEY_FRONT_OFFSET = -1.5625D;
    private static final double VISUAL_CHIMNEY_TOP_Y_OFFSET = 1.5944D;
    ...
    public SentinelY3SteamLocomotive(EntityType<? extends SentinelY3SteamLocomotive> type, Level level) {
        super(type, level);
    }
    ...
    public void tick() {
        super.tick();
        LegacyRollingStockDebug.logEntity(this, "Sentinel Y3 Steam Locomotive");
    }

    @Override
    protected Item getDropItem() {
        return TCItems.LOCOMOTIVE_STEAM_SENTINEL_Y3.get();
    }

    @Override
    public ItemStack getPickResult() {
        return new ItemStack(TCItems.LOCOMOTIVE_STEAM_SENTINEL_Y3.get());
    }
}
