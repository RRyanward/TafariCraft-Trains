/* Step 8.4.5 Batch B6: Skookum Steam Locomotive. Debug intentionally enabled. */
...
public class SkookumSteamLocomotive extends SmallSteamLocomotive {

    /*
     * STEP_8_5_12A_R1_REALISM
     * Step 8.5.12a-r1 Batch E per-locomotive realism.
     * Baldwin Skookum 2-4-4-2: about 73.8 t locomotive mass and 24,600 lbf tractive effort; 40 km/h is gameplay/service calibration.
     ...
     */
    private static final double REALISM_MASS_T = 73.8D;
    private static final double REALISM_TRACTION_REFERENCE_MASS_T = 312.7D;
    private static final double REALISM_BASE_ACCELERATION_MPS2 = 0.350D;
    private static final double REALISM_MAX_FORWARD_BPT = 40.0D / 72.0D;
    private static final double REALISM_MAX_REVERSE_BPT = 40.0D / 72.0D;
     ...
     */
    private static final double VISUAL_DRIVER_SEAT_BACK_OFFSET = 2.1952D;
    ...
    private static final double VISUAL_CHIMNEY_FRONT_OFFSET = 1.2500D;
    ...
    public SkookumSteamLocomotive(EntityType<? extends SkookumSteamLocomotive> type, Level level) {
        super(type, level);
    }
    ...
    public void tick() {
        super.tick();
        LegacyRollingStockDebug.logEntity(this, "Skookum Steam Locomotive");
    }

    @Override
    protected Item getDropItem() {
        return TCItems.LOCOMOTIVE_STEAM_SKOOKUM.get();
    }

    @Override
    public ItemStack getPickResult() {
        return new ItemStack(TCItems.LOCOMOTIVE_STEAM_SKOOKUM.get());
    }
}
