/* Step 8.4.5 Batch B6: RW Type 2 Steam Locomotive. Debug intentionally enabled. */
...
public class RwType2SteamLocomotive extends SmallSteamLocomotive {
    /*
     ...
     */
    private static final double VISUAL_DRIVER_SEAT_BACK_OFFSET = 0.0365D;
    ...
    private static final double VISUAL_CHIMNEY_FRONT_OFFSET = 2.1875D;
     ...
     * Traincraft RW Type 2: no reliable prototype specification was identified in the audited source/history. Conservative medium-steam representative candidate; runtime validation required before freeze.
    ...
    public RwType2SteamLocomotive(EntityType<? extends RwType2SteamLocomotive> type, Level level) {
        super(type, level);
    }
    ...
    public void tick() {
        super.tick();
        LegacyRollingStockDebug.logEntity(this, "RW Type 2 Steam Locomotive");
    }

    @Override
    protected Item getDropItem() {
        return TCItems.LOCOMOTIVE_STEAM_RW_TYPE_2.get();
    }

    @Override
    public ItemStack getPickResult() {
        return new ItemStack(TCItems.LOCOMOTIVE_STEAM_RW_TYPE_2.get());
    }
}
