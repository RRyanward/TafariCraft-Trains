/* Step 8.4.4 Batch B5: Shay 3-Truck Steam Locomotive. Debug intentionally enabled. */
...
public class Shay3TruckSteamLocomotive extends SmallSteamLocomotive {

    /*
     * STEP_8_5_12A_R1_REALISM
     * Step 8.5.12a-r1 Batch E per-locomotive realism.
     * Representative Lima Class C 70-3 three-truck Shay: about 77.6 t service mass, 30,375 lbf tractive effort, 19 mph safe speed.
     ...
     */
    private static final double REALISM_MASS_T = 77.6D;
    private static final double REALISM_TRACTION_REFERENCE_MASS_T = 386.1D;
     ...
     */
    private static final double VISUAL_DRIVER_SEAT_BACK_OFFSET = 0.3675D;
    ...
    private static final double VISUAL_CHIMNEY_FRONT_OFFSET = 0.9063D;
    private static final double VISUAL_CHIMNEY_TOP_Y_OFFSET = 1.8128D;
    ...
    public Shay3TruckSteamLocomotive(EntityType<? extends Shay3TruckSteamLocomotive> type, Level level) {
        super(type, level);
    }
    ...
    public void tick() {
        super.tick();
        LegacyRollingStockDebug.logEntity(this, "Shay 3-Truck Steam Locomotive");
    }

    @Override
    protected Item getDropItem() {
        return TCItems.LOCOMOTIVE_STEAM_SHAY_3_TRUCK.get();
    }

    @Override
    public ItemStack getPickResult() {
        return new ItemStack(TCItems.LOCOMOTIVE_STEAM_SHAY_3_TRUCK.get());
    }
}
