/* Step 8.4.3 Batch B4: Berkshire 1225 Steam Locomotive. Debug intentionally enabled. */
...
public class Berkshire1225SteamLocomotive extends SmallSteamLocomotive {
    /*
     * STEP_8_5_8A_R1_REALISM
     * Step 8.5.8a-r1 Batch A per-locomotive realism calibration.
     * Pere Marquette 1225: 200.7 t locomotive, 308.5 kN starting TE, 70 mph maximum speed.
     ...
     */
    private static final double REALISM_MASS_T = 200.7D;
    private static final double REALISM_TRACTION_REFERENCE_MASS_T = 771.2D;
    ...
    private static final double VISUAL_DRIVER_SEAT_Y_OFFSET = 0.3278D;
    ...
    public Berkshire1225SteamLocomotive(EntityType<? extends Berkshire1225SteamLocomotive> type, Level level) {
        super(type, level);
    }
    ...
    public void tick() {
        super.tick();
        LegacyRollingStockDebug.logEntity(this, "Berkshire 1225 Steam Locomotive");
    }

    @Override
    protected Item getDropItem() {
        return TCItems.LOCOMOTIVE_STEAM_BERKSHIRE_1225.get();
    }

    @Override
    public ItemStack getPickResult() {
        return new ItemStack(TCItems.LOCOMOTIVE_STEAM_BERKSHIRE_1225.get());
    }
}
