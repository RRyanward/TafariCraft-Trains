...
public final class D51LongSteamLocomotiveRenderer extends LegacyMultiMeshRenderer<D51LongSteamLocomotive> {
    public D51LongSteamLocomotiveRenderer(EntityRendererProvider.Context context) {
        super(context, "D51 Long Steam Locomotive", new Part[] {
                part(
                        new ResourceLocation(Traincraft.MOD_ID, "legacy_meshes/locomotive_steam_d51_long_body.tcm"),
                        new ResourceLocation(Traincraft.MOD_ID, "textures/trains/legacy/locomotive_steam_d51_long_body.png"),
    ...
    @Override
    protected float trainYaw(D51LongSteamLocomotive entity, float partialTicks) {
