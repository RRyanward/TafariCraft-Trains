/*
 * Step 8.3.2-r5 locked production renderer for BR01 Steam Locomotive.
...
public class Br01SteamLocomotiveRenderer extends EntityRenderer<Br01SteamLocomotive> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(
            Traincraft.MOD_ID, "textures/trains/locobr01_db_black.png");

    private final ModelPart model;

    public Br01SteamLocomotiveRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = Br01SteamLocomotiveModel.root(context.bakeLayer(Br01SteamLocomotiveModel.LAYER));
        this.shadowRadius = 1.10F;
    }

    @Override
    public void render(Br01SteamLocomotive entity, float entityYaw, float partialTicks,
        ...
        poseStack.translate(-1.0000D, 0.0000D, 0.0000D);
    ...
    @Override
    public ResourceLocation getTextureLocation(Br01SteamLocomotive entity) {
        return TEXTURE;
    }
}
