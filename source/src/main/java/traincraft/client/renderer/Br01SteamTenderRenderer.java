/*
 * Step 8.3.2 frozen production renderer for BR01 Tender.
...
public class Br01SteamTenderRenderer extends EntityRenderer<Br01SteamTender> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(
            Traincraft.MOD_ID, "textures/trains/tenderbr01_db.png");

    private final ModelPart model;

    public Br01SteamTenderRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = Br01SteamTenderModel.root(context.bakeLayer(Br01SteamTenderModel.LAYER));
        this.shadowRadius = 1.10F;
    }

    @Override
    public void render(Br01SteamTender entity, float entityYaw, float partialTicks,
        ...
        poseStack.translate(0.0000D, 0.0000D, 0.0000D);
    ...
    @Override
    public ResourceLocation getTextureLocation(Br01SteamTender entity) {
        return TEXTURE;
    }
}
